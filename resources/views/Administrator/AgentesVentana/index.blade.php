  ...
  <tbody>
    ...
    <tr>
      ...
      @method('DELETE')
        ...
        <button type="submit" title="Quitar agente de la ventana" onclick="return confirm('esta seguro de Quitar a {{$AgentesVentanas->nombre_agente}} de la {{$AgentesVentanas->nombre_ventanilla}} ')">
        <i class='fas fa-trash text-success' style='font-size:20px'></i></button>   
      </form>     
      </td>
