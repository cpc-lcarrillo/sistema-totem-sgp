...
<html lang="en">
  <head>
    ...
    <title>Deposito-Atención General</title>
...
<div class="form-group row">
    ...
    <div class="col-sm-3">
    	<input type="hidden" name="mision" value="Deposito-Atencion-General">
...
@if (Session::has('message'))
 ...
 @endif
    ...
    <div class="col">
      ...
      <a href="Deposito-Atencion-General" class="btn btn-primary">Limpiar</a>
