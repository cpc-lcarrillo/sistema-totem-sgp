...
<div class="container ">
  ...
  <form action="{{ route('totem.update',1) }}" method="POST">
    @csrf
    @method('PUT')   
<div class="form-group row">
    ...
    <div class="col-sm-3">
    	<input type="hidden" name="mision" value="Reexpedicion">
      <input type="text"  class="form-control" name="patente" maxlength="6" size="12" placeholder="ej. LL0NNN" required="" autofocus>
...
@if (Session::has('message'))
 ...
 @endif
    ...
    <div class="col">
      ...
      <a href="reexpedicion" class="btn btn-primary">Limpiar</a>
