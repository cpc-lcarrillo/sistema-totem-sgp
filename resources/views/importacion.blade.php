...
<div class="form-group row">
    ...
    <div class="col-sm-3">
    	<input type="hidden" name="mision" value="Importacion">
      <input type="text"  class="form-control" name="patente" maxlength="6" size="12" placeholder="ej. LL0NNN" autofocus>
...
@if (Session::has('message'))
 ...
 @endif
    ...
    <div class="col">
      ...
      <a href="importacion" class="btn btn-primary">Limpiar</a>
