...
<html lang="en">
  <head>
    ...
    <title>Deposito-Atención General Refeers</title>
...
<div class="form-group row">
    ...
    <div class="col-sm-3">
    	<input type="hidden" name="mision" value="Deposito-Atencion-General-Refeer">
...
@if (Session::has('message'))
 ...
 @endif
    ...
    <div class="col">
      ...
      <a href="Deposito-Atencion-General-Refeer" class="btn btn-primary">Limpiar</a>
