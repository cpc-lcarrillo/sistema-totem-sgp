...
<div class="container ">
 ...
 <form action="{{ route('Transportista.update',1) }}" method="POST">
...
<div class="form-group row">
    ...
    <label for="staticEmail" class="col-sm-2 col-form-label-lg">Buscar Patente:</label>
    <div class="col-sm-3">
    	<!-- <input type="hidden" name="mision" value="Sin mision"> -->
      <input type="text"  class="form-control" name="patente" maxlength="6" size="12" placeholder="ej. LL0NNN">
    ...
    <div class="col">
      ...
      <a href="Transportista" class="btn btn-primary">Limpiar</a>
     
        
    
      <!-- <a href="Transportista" class="btn btn-primary">Volver</a> -->
    </div>
