...
<div class="col-12">
  <div class="d-flex justify-content-center">
     <a href="agendado" class="btn coloruno btn-lg btn-block text-white" id="activa4">ACO EXPO</a>
...
var ancla5 = document.getElementById('activa5');
    ...
    success:function(data){      
      ...
      for(var i=0; i< data.length; i++  ){
        ...
        if(data[i].activado_bloque === 1){ ///cambiar a 1
		  ...
		  ancla5.classList.remove('disabled');
          msj.innerHTML='';
        }
      }
